defmodule DiscordLiveWeb.ServerLive.Index do
  use DiscordLiveWeb, :live_view

  alias DiscordLive.Servers
  alias DiscordLive.Servers.Server
  ...
  @impl true
  def handle_info({DiscordLiveWeb.ServerLive.FormComponent, {:saved, server}}, socket) do
